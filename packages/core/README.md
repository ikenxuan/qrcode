...
基于 Rust [qr-code-styling](https://crates.io/crates/qr-code-styling) + [rxing](https://crates.io/crates/rxing) 的高性能 QR 码生成与扫描工具。通过 WebAssembly 提供高性能核心，Node.js import 即用。
