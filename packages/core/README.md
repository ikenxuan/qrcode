...
基于 Rust [qr-code-styling](https://crates.io/crates/qr-code-styling) + [rxing](https://crates.io/crates/rxing) 的高性能 QR 码生成与扫描工具。通过 WebAssembly 实现跨平台运行，Node.js 和浏览器通用。
